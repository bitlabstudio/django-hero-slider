...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'hero_slider.slideritem': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hero_slider.SliderItemCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        u'hero_slider.slideritemcategorytranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'SliderItemCategoryTranslation', 'db_table': "u'hero_slider_slideritemcategory_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['hero_slider.SliderItemCategory']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'hero_slider.slideritemtranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'SliderItemTranslation', 'db_table': "u'hero_slider_slideritem_translation'"},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'link_text': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['hero_slider.SliderItem']"}),
