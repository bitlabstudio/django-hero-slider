...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderItem.external_url'
        db.add_column('hero_slider_slideritem', 'external_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


        # Changing field 'SliderItem.object_id'
        db.alter_column('hero_slider_slideritem', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SliderItem.content_type'
        db.alter_column('hero_slider_slideritem', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):
        # Deleting field 'SliderItem.external_url'
        db.delete_column('hero_slider_slideritem', 'external_url')
