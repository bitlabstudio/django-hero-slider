...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hero_slider_slideritem', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hero_slider.SliderItemCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliderItem.category'
        db.delete_column('hero_slider_slideritem', 'category_id')
